...
<div class="form-horizontal">
	{!! Form::model($model, ['files' => true, 'method' => 'PUT', 'route' => ['admin.challenges.update', $model->id]]) !!}
...
<!-- 3rd party libraries for Form Advanced Elements -->
    ...
    <script src="{!! asset('app/scripts/admin_categories_edit.js') !!}" type="text/javascript" charset="utf-8"></script>
