$(document).ready(function() {
    ...
    var myDropzoneCoverTip = new Dropzone("#coverImageTipDropzone", {
        url: document.location.origin + '/admin/posts/uploadImage',
        paramName: "coverImageTipDropzone", // The name that will be used to transfer the file
        maxFiles: 1,
        method: "POST",
        ...
        sending: function(file, xhr, formData) {
            ...
            formData.append("media_path", $('#media_path').val());
        },
        success: function(file, response) {
            myDropzoneCoverTip.removeFile(file);
            ...
            if (cover.success == true){
                ...
                $("#media_path").val(cover.image).attr('disable',true);
            }
        },
